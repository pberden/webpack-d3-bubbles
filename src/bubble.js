...
function bubbleChart() {
  ...
  // Convert tag into emoticon
  var fillIcon = d3.scaleOrdinal()
    .domain(['a', 'b', 'c', 'd', 'e'])
    .range(['👫', '🐼', '⚙', '🎲', '🍺']);
  ...
  var chart = function chart(selector, rawData) {
    ...
    // Create new g elements each with class `bubble`.
    // There will be one g.bubble for each object in the nodes array.
    ...
    bubblesE.append('text')
      .text(function (d) { return fillIcon(d.tag); })
